# SAL-33 to Saddle Powerbox Adapter

3D-printable adapter puck for adding the Saddle Powerbox to the SAL-33 mount.

![Puck Adapter](/images/puck.jpeg)

![Ssaddle mounted on SAL-33](/images/saddle-mounted.jpeg)
...
The Saddle Powerbox comes with 4x M5*6mm screws which will work with this.  Reuse the same screws from the SAL-33 to mount the puck to the harmonic drive.
